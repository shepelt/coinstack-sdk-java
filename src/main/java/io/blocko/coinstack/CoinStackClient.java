...
public class CoinStackClient {
	...
	/**
	 * Create MultiSig transaction. MultiSig Transaction is a transaction of which the condition
	 * of redemption requires multi private keys.
	 * 
	 * @param builder
	 *            TransactionBuilder object that Coinstack provides
	 *            Basic information to build Multisig transaction
	 * @param privateKeys
	 *            A list of private keys which are required to meet redeem script
	 *            
	 * @param redeemScript
	 *            Redeemscript which is initially generated by using multiple private keys to fund
	 *            Multisig transaction and handed over to receivers.
	...
	/**
	 * Create MultiSig transaction with partial sign. 
	 * This method is used to make a incomplete transaction by using a private key.
	 * And this incomplete transaction will delivered to other signers who have another private key.
	 * 
	 * @param builder
	 *            TransactionBuilder object that Coinstack provides
	 *            Basic information to build Multisig transaction
	 * @param privateKey
	 *            One of multiple private keys which are required to meet redeem script
	 *            
	 * @param redeemScript
	 *            Redeem script which is initially generated by using multiple private keys
	 * @return incomplete transaction signed and note ready to be broadcasted in hex-encoded
	 *         string  
	 * @throws IOException
	 *             in case of network failure
	 * @throws InsufficientFundException
	 ...
	 *             blockchain             
	 */
	public String createMultiSigTransactionWithPartialSign(TransactionBuilder builder, String privateKey,
		...
		Output[] outputs = this.getUnspentOutputs(from);
		try {
			injectOutputs(txTemplate, outputs, privateKey, redeem, totalSpendValue + builder.getFee(), from);
		} catch (AddressFormatException e) {
	 ...
	 * This method is to finalize incomplete Multisig transaction with last signature
	 * required to meet a redeem script
	 * 
	 * @param transactionSerialized
	 *            Incomplete transaction which is the result of createMultiSigTransactionWithPartialSign
	 * @param myPrivateKey
	 *                      
	 * @param redeemScript
	 *            Redeem script which is initially generated by using multiple private keys
	 ...
	 * 
	 * @param documentHash
	 *            a String to be registered on the Blockchain
	 *            the value should be hex
	 * @return result of stamping is blockchain transaction ID and vout, offset value of outputs
	 *         
	 * @throws IOException
	 *             in case of network failure
     * @throws MalformedInputException
     * 			   hash value should be hex value. If it is not, this exception is populated
	 */
	...
	/**
	 * Inquiry the information of Stamping
	 * Data and time to stamp, number of confirmations are provided
	 * 
	 * @param stampId
	 *            stampId is the result of stampDocument method which is consisted of
	 *            txID and vout
	 *           
	 * @return Stamp object containing transaction id, vout, number of confirmations, and date
	 */
