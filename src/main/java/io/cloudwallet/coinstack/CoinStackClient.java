...
public class CoinStackClient {
	...
	public static String createNewPrivateKey() {
		return io.cloudwallet.coinstack.ECKey.createNewPrivateKey();
	}

	@Deprecated
	public static String createNewPrivateKey(boolean isMainNet) {
		return io.cloudwallet.coinstack.ECKey.createNewPrivateKey(isMainNet);
	}
	...
	public static boolean validateAddress(String address) {
		return io.cloudwallet.coinstack.ECKey.validateAddress(address, true);
	}
	...
	public static boolean validateAddress(String address, boolean isMainNet) {
		return io.cloudwallet.coinstack.ECKey.validateAddress(address, isMainNet);
	}
