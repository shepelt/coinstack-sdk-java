 ...
 *
 */
public class CoinStackClientWithProxyBackendTest extends CoinStackClientTest {
	...
	public void setUp() throws Exception {
		coinStackClient = new CoinStackClient(new CredentialsProvider() {
			...
			public PublicKey getPublicKey() {
				return Endpoint.MAINNET.getPublicKey();
//				return null;
			}

			@Override
			public String endpoint() {
				return "https://52.74.5.228";
			}
		});
	}
	...
	public void testCreateTransaction() throws Exception {
		...
		rawTx = coinStackClient.createSignedTransaction(builder, privateKeyWIF);
		System.out.println(rawTx);
		System.out.println(TransactionUtil.getTransactionHash(rawTx));
		// coinStackClient.sendTransaction(rawTx);
	}
